    ...
    educationHistory: [
      {
        ...
        period: "2023 - 2027",
        description:
          "برنامج شامل يغطي أساسيات البرمجة وتقنيات حل المشكلات وهياكل البيانات والخوارزميات. تركيز إضافي على تحليل النظم ولغات البرمجة المتعددة بما في ذلك ++C وJava وAssembly وPL/SQL.",
        icon: <GraduationCap className="w-8 h-8 text-primary" />
      },
      {
