...
import { BookOpen, Code, Database, Cpu, BrainCircuit, Code2 } from 'lucide-react';
...
const learningCourses = [
  {
    ...
    descriptionEn: 'Built full-stack applications using Laravel MVC architecture and Blade templating. Developed secure APIs with JWT authentication and custom CMS for content management.',
  ...
  },
  {
    ...
    descriptionEn: 'Built scalable server-side applications using Node.js and Express.js with RESTful API development. Integrated MongoDB and implemented user authentication systems using EJS templating.',
  ...
  },
  {
    ...
    descriptionEn: 'Mastered core PHP programming including OOP principles, session/cookie management, and MySQL database design. Implemented MVC pattern by developing a fully functional book management system with CRUD operations.',
  ...
  },
  {
    ...
    descriptionEn: 'Developed dynamic UIs with React.js using component-based architecture. Achieved 30% faster rendering with React hooks and 100% responsive designs using Material-UI.',
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        ...
        <Tabs defaultValue="0" orientation="vertical" className="flex flex-col md:flex-row gap-4 md:gap-8">
          <TabsList 
          ...
          >
            {learningCourses.map((course, index) => (
              ...
              >
                {React.cloneElement(course.icon as React.ReactElement, { className: "h-5 w-5" })}
                {course.platform}
              </TabsTrigger>
            ))}
          </TabsList>
          ...
          <div className="flex-1">
            {learningCourses.map((course, index) => (
              <TabsContent 
                ...
                style={{ transitionDelay: `${index * 0.15}s` }} // تأخير متدرج لكل عنصر
              >
