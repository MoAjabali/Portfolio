...
export function AboutMeSection() {
  ...
  const [imageRef, isImageVisible] = useScrollAnimation<HTMLDivElement>({ threshold: 0.3, triggerOnce: true });
  const [card1Ref, isCard1Visible] = useScrollAnimation<HTMLDivElement>({ threshold: 0.2, triggerOnce: true });
  const [card2Ref, isCard2Visible] = useScrollAnimation<HTMLDivElement>({ threshold: 0.2, triggerOnce: true });
