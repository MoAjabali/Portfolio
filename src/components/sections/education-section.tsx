...
const educationHistory = [
  {
    ...
    period: '2023 - 2027',
    description: 'Comprehensive program covering programming fundamentals, problem-solving techniques, data structures, and algorithms. Additional focus on system analysis and multiple programming languages including C++, Java, Assembly, and PL/SQL.',
  ...
  },
  {
    ...
    degree: 'TOEFL iBT',
    period: '2024 - 2025',
    description: 'Intensive training focusing on all test sections: Reading, Listening, Speaking, and Writing. Included test-taking strategies and score-boosting techniques.',
  ...
  },
  {
    ...
    period: '2024 - 2025',
    description: 'Practical-oriented course covering Python essentials: loops, conditional statements, OOP concepts, API integration, and real-world application development.',
    icon: <BookOpen className="h-8 w-8 text-primary" />,
  },
  {
    institution: 'American French World Institute',
    ...
    period: '2023 - 2024',
    description: 'Advanced English program using American English File curriculum. Focused on vocabulary expansion, advanced grammar, and soft skills development including presentations and professional communication.',
    icon: <BookOpen className="h-8 w-8 text-primary" />,
  },
];
