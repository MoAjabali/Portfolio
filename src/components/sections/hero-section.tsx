  ...
  return (
    <section id="hero" className="relative flex min-h-[calc(100vh-4rem)] w-full items-center justify-center overflow-hidden py-20 md:py-32">
      <div className="container mx-auto max-w-screen-md px-4 text-center">
        <h1 className="font-headline text-5xl font-extrabold tracking-tight text-foreground sm:text-6xl md:text-7xl animate-fade-in" style={{ animationDelay: '0.2s' }}>
          Welcome to My Universe
        </h1>
        <p className="mt-6 max-w-xl mx-auto text-lg text-muted-foreground sm:text-xl md:text-2xl animate-fade-in" style={{ animationDelay: '0.4s' }}>
        ...
        <p className="mt-4 max-w-xl mx-auto text-md text-primary sm:text-lg animate-fade-in" style={{ animationDelay: '0.6s' }}>
