...
type ProjectCategory = 'all' | 'frontend' | 'backend' | 'full-stack' | 'other';
    ...
    >
      <Card className="bg-card/80 shadow-xl flex flex-col overflow-hidden h-full hover:shadow-primary/30">
        <CardHeader className="p-0">
          ...
          > 
            <Video className="h-5 w-5 text-primary/70" />{project.title} video
          </video>
        </CardHeader>
        ...
        <CardFooter className="p-6 border-t border-border/50 flex justify-between items-center mt-auto">
          <div className="flex space-x-2">
            ...
            <Button variant="ghost" size="sm" asChild className="hover:bg-primary hover:text-primary-foreground">
